<template>
  <footer class="glass border-t border-white/10 mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-lg font-semibold text-white">开发者网站</span>
          </div>
        ...
        <div>
          ...
          <div class="space-y-2">
            <router-link
              ...
              :key="item.path"
              :to="item.path"
              class="block text-gray-400 hover:text-white transition-colors duration-200 text-sm"
            >
              {{ item.name }}
            </router-link>
          </div>
      ...
      <div class="border-t border-white/10 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between">
