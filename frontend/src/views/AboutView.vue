  ...
  <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
      <div class="text-center mb-16">
        <div class="w-40 h-40 mx-auto rounded-2xl bg-gradient-to-br from-primary-500 to-accent-500 p-1 mb-8 glow-border">
          <div class="w-full h-full rounded-xl bg-dark-100 flex items-center justify-center">
            <span class="text-7xl">👨‍💻</span>
          </div>
        </div>
        <h1 class="text-4xl sm:text-5xl font-bold text-white mb-4">关于我</h1>
        <p class="text-xl text-gray-400">全栈开发者 · 技术博主 · 开源贡献者</p>
      </div>

      <div class="glass rounded-2xl p-8 mb-8">
        <h2 class="text-2xl font-semibold text-white mb-6">个人简介</h2>
        <div class="prose prose-invert max-w-none text-gray-300 space-y-4">
          <p>
            你好！我是一名拥有多年全栈开发经验的开发者，专注于现代 Web 技术和人工智能领域。
            我热衷于构建高性能、可扩展的应用，并乐于分享技术知识和经验。
          </p>
          <p>
            在过去的几年里，我参与了多个大型项目的开发，涵盖电商、社交、AI 等多个领域。
            我熟悉从前端到后端、从开发到部署的完整技术栈。
          </p>
          <p>
            除了工作，我也积极维护开源项目，撰写技术博客，希望能为技术社区贡献自己的一份力量。
          </p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="glass rounded-2xl p-6">
          <h3 class="text-xl font-semibold text-white mb-4 flex items-center">
            <span class="w-8 h-8 rounded-lg bg-primary-500/20 flex items-center justify-center mr-3">
              <span>💼</span>
            </span>
            工作经历
          </h3>
          <div class="space-y-4">
            <div class="border-l-2 border-primary-500 pl-4">
              <h4 class="text-white font-medium">高级全栈工程师</h4>
              <p class="text-gray-400 text-sm">某科技公司 · 2022 - 至今</p>
            </div>
            <div class="border-l-2 border-primary-500 pl-4">
              <h4 class="text-white font-medium">全栈开发工程师</h4>
              <p class="text-gray-400 text-sm">某互联网公司 · 2019 - 2022</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass rounded-2xl p-6">
          <h3 class="text-xl font-semibold text-white mb-4 flex items-center">
            <span class="w-8 h-8 rounded-lg bg-accent-500/20 flex items-center justify-center mr-3">
              <span>🎓</span>
            </span>
            教育背景
          </h3>
          <div class="space-y-4">
            <div class="border-l-2 border-accent-500 pl-4">
              <h4 class="text-white font-medium">计算机科学与技术</h4>
              <p class="text-gray-400 text-sm">某重点大学 · 2015 - 2019</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="glass rounded-2xl p-8 mb-8">
        <h3 class="text-xl font-semibold text-white mb-6">技术栈</h3>
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
          <div
            v-for="skill in skills"
            :key="skill.category"
            class="text-center p-4 bg-dark-50/50 rounded-xl"
          >
            <div class="text-2xl mb-2">{{ skill.icon }}</div>
            <h4 class="text-white font-medium mb-2">{{ skill.category }}</h4>
            <p class="text-gray-400 text-sm">{{ skill.items.join(' · ') }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="glass rounded-2xl p-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <a
            ...
            :key="contact.label"
            :href="contact.href"
            class="flex items-center p-4 bg-dark-50/50 rounded-xl hover:bg-white/5 transition-colors duration-200"
          >
            <span class="text-2xl mr-4">{{ contact.icon }}</span>
            <div>
              <p class="text-gray-400 text-sm">{{ contact.label }}</p>
...
const contacts = [
  { label: '邮箱', value: 'developer@example.com', href: 'mailto:developer@example.com', icon: '📧' },
  { label: 'GitHub', value: 'github.com/developer', href: 'https://github.com', icon: '🐙' },
